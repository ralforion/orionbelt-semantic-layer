...
[![Version 2.18.2](https://img.shields.io/badge/version-2.18.2-purple.svg)](https://github.com/ralforion/orionbelt-semantic-layer/releases)
...
services:
  api:
    image: ralforion/orionbelt-semantic-layer-api:2.18.2
    ports: ["8080:8080"]
    env_file: .env
    volumes:
  ...
  ui:
    image: ralforion/orionbelt-semantic-layer-ui:2.18.2
    ports: ["7860:7860"]
    environment:
...
> - For production, pin a version tag (`:2.18.2`) rather than `:latest`.
