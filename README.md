...
<p align="center">
<a href="https://github.com/ralforion/orionbelt-semantic-layer/releases"><img src="https://img.shields.io/badge/version-2.29.0-purple.svg" alt="Version 2.29.0"></a>
...
services:
  api:
    image: ralforion/orionbelt-semantic-layer-api:2.29.0
    ports: ["8080:8080"]
    env_file: .env
    volumes:
  ...
  ui:
    image: ralforion/orionbelt-semantic-layer-ui:2.29.0
    ports: ["7860:7860"]
    environment:
...
> - For production, pin a version tag (`:2.29.0`) rather than `:latest`.
