...
[![Version 2.10.0](https://img.shields.io/badge/version-2.10.0-purple.svg)](https://github.com/ralfbecher/orionbelt-semantic-layer/releases)
...
services:
  api:
    image: ralforion/orionbelt-api:2.10.0
    ports: ["8080:8080"]
    env_file: .env
    volumes:
  ...
  ui:
    image: ralforion/orionbelt-ui:2.10.0
    ports: ["7860:7860"]
    environment:
...
> - For production, pin a version tag (`:2.10.0`) rather than `:latest`.
