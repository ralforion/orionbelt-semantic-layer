...
[![Version 2.23.1](https://img.shields.io/badge/version-2.23.1-purple.svg)](https://github.com/ralforion/orionbelt-semantic-layer/releases)
...
> - For production, pin a version tag (`:2.23.1`) rather than `:latest`.
