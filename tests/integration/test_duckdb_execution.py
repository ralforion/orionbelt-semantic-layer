...
class TestDuckDBRollupCube:
    """End-to-end: compile WITH ROLLUP/CUBE and execute against real DuckDB.
    ...
    def test_rollup_single_dim_row_count_and_grand_total(
        self, duckdb_conn, sales_model, pipeline
    ) -> None:
    ...
    def test_rollup_two_dims_country_subtotals(self, duckdb_conn, sales_model, pipeline) -> None:
    ...
    def test_cube_two_dims_full_lattice(self, duckdb_conn, sales_model, pipeline) -> None:
