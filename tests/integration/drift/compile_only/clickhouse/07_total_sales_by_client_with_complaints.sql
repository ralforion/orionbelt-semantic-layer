...
UNION ALL
SELECT CAST(NULL AS Nullable(String)) AS "Sales Client Name", "Clients"."clientname" AS "Complaint Client Name", CAST(round(NULL, 2) AS Nullable(Decimal(18, 2))) AS "Total Sales", "Client Complaints"."complid" AS "Complaint Count"
