...
SELECT "Countries"."countryname" AS "Sales Country Name", "Sales"."salesamount" AS "Total Sales", CAST(round(NULL, 2) AS Nullable(Decimal(18, 2))) AS "Total Returns"
...
UNION ALL
SELECT "Countries"."countryname" AS "Sales Country Name", CAST(round(NULL, 2) AS Nullable(Decimal(18, 2))) AS "Total Sales", "Returns"."returnamount" AS "Total Returns"
