...
SELECT "Countries"."countryname" AS "Sales Country Name", CAST(round(toDecimal256(toString("Sales"."salesamount"), 20), 20) AS Nullable(Decimal(76, 20))) AS "Total Sales", CAST(NULL AS Nullable(Decimal(76, 20))) AS "Total Returns"
...
UNION ALL
SELECT "Countries"."countryname" AS "Sales Country Name", CAST(NULL AS Nullable(Decimal(76, 20))) AS "Total Sales", CAST(round(toDecimal256(toString("Returns"."returnamount"), 20), 20) AS Nullable(Decimal(76, 20))) AS "Total Returns"
