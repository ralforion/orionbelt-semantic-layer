...
CAST(TRUNC(((EXTRACT(YEAR FROM DATE_TRUNC('quarter', CAST('2026-04-01' AS DATE))) - EXTRACT(YEAR FROM DATE_TRUNC('quarter', CAST('2026-03-31' AS DATE)))) * 12 + (EXTRACT(MONTH FROM DATE_TRUNC('quarter', CAST('2026-04-01' AS DATE))) - EXTRACT(MONTH FROM DATE_TRUNC('quarter', CAST('2026-03-31' AS DATE))))) / 3) AS INTEGER);
