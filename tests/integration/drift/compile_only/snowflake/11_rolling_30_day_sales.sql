...
SELECT "Sales Date" AS "Sales Date", CAST(AVG("Total Sales") OVER (ORDER BY "Sales Date" ASC ROWS BETWEEN 29 PRECEDING AND CURRENT ROW) AS NUMBER(18, 2)) AS "Rolling 30 Day Sales"
