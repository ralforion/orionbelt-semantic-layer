...
-- to_number(x)
--   to_number('4.6') = 4.6
CASE WHEN (TRIM('4.6') REGEXP '^[+-]?([0-9]+([.][0-9]*)?|[.][0-9]+)([eE][+-]?[0-9]+)?$') THEN CAST(TRIM('4.6') AS DOUBLE) END;
--   to_number('abc') = None
CASE WHEN (TRIM('abc') REGEXP '^[+-]?([0-9]+([.][0-9]*)?|[.][0-9]+)([eE][+-]?[0-9]+)?$') THEN CAST(TRIM('abc') AS DOUBLE) END;
