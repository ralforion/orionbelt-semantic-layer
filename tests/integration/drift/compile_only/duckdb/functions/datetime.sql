...
(CAST('2026-01-01' AS DATE) + (1 + 1) * INTERVAL '1 quarter');
...
(DATE_DIFF('day', DATE_TRUNC('week', CAST('2026-08-09' AS DATE)), DATE_TRUNC('week', CAST('2026-08-15' AS DATE))) // 7);
