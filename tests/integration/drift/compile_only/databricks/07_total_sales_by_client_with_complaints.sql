...
SELECT `Clients`.`clientname` AS `Sales Client Name`, CAST(NULL AS VARCHAR) AS `Complaint Client Name`, `Sales`.`salesamount` AS `Total Sales`, CAST(NULL AS BIGINT) AS `Complaint Count`
